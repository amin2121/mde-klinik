			...
			<div class="content-wrapper">
				...
				<div class="panel panel-flat border-top-success border-top-lg">
					<div class="panel-heading">
						<h5 class="panel-title">Selamat Datang di Menu Pegawai,</h5>
					</div>

					<div class="panel-body">
						<p class="content-group"> Silahkan Klik menu disamping untuk memulai layanan Pegawai</p>
						<div class="row">
						<?php
							$level = $this->session->userdata('level');
							$q_menu = $this->db->query("SELECT a.* FROM pengaturan_hak_akses a LEFT JOIN menu_2 b ON a.id_menu = b.id WHERE a.level = '$level' AND a.tipe_menu = 'Menu 2' AND b.id_menu_1 = '4'")->result_array();
							foreach ($q_menu as $p) {
								$id_menu = $p['id_menu'];

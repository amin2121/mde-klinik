								...
								<div class="panel-body">
									<div class="row">
										<div class="col-sm-12">
											...
											<div class="form-search form-horizontal">
												...
												<div class="row" style="margin-bottom: 1em;">
													<div class="col-sm-6">
														...
														<button class="btn btn-success" onclick="get_hapus_riwayat_kasir_umum()"><i class="icon-book2 position-left"></i> Lihat Semua</button>
													</div>
												</div>
											...
											<!-- Modal Hapus Riwayat Penjualan apotek -->
											<div id="modal_hapus_semua" class="modal fade">
												<div class="modal-dialog">
													<div class="modal-content">
														...
														<form action="<?= base_url('apotek/riwayat_hapus_kasir_umum/hapus_semua_riwayat_kasir_umum') ?>" method="POST">
...
function get_hapus_riwayat_kasir_umum() {
	...
	$.ajax({
		url : '<?= base_url('apotek/riwayat_hapus_kasir_umum/get_riwayat_hapus_kasir_umum') ?>',
		method : 'POST',
		data : {
...
function detail_hapus_riwayat_kasir_umum(id_penjualan, id_riwayat_hapus_kasir_umum) {
	...
	$.ajax({
		url : '<?= base_url('apotek/riwayat_hapus_kasir_umum/get_detail_hapus_riwayat_kasir_umum') ?>',

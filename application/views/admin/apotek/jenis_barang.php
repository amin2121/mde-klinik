								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="tambah-jenis-barang">
										<fieldset class="content-group">
											<form action="<?= base_url('apotek/master/tambah_jenis_barang') ?>" id="form-tambah-jenis-barang" method="POST">
...
<script>
	$(document).ready(() => {
		...
		// $('#popup_load').show();
		$.ajax({
			url : '<?= base_url('apotek/master/get_jenis_barang_ajax') ?>',
			method : 'POST',
			dataType : 'json',
									...
									<div id="modal_ubah_jenis_barang_${item.id}" class="modal fade">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form action="<?= base_url('apotek/master/ubah_jenis_barang') ?>" id="form-ubah-jenis-barang" method="POST">
									...
									<div id="modal_hapus_jenis_barang_${item.id}" class="modal fade">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross position-left"></i> keluar</button>
													<a href="<?= base_url('apotek/master/hapus_jenis_barang?id_jenis_barang=') ?>${item.id}" class="btn btn-danger"><i class="icon-bin position-left"></i> Hapus</a>
												</div>
											</div>
										</div>
									</div>

							...
							<div class="form-search form-horizontal">
								...
								<div class="row">
									<div class="col-sm-6">
										...
										<button class="btn btn-md btn-success" onclick="get_resep_obat()"><i class="icon-book2 position-left"></i> Lihat Semua</button>
									</div>
								</div>
							</div>
	...
	function paging_resep($selector){
	    ...
	    if(typeof $selector == 'undefined'){
			...
			window.tp = new Pagination('#pagination_resep', {
					itemsCount:$(".table-resep #tbody-resep-obat tr").length,
	        ...
	        onPageChange: function (paging) {
	            var start = paging.pageSize * (paging.currentPage - 1),
	                ...
	                $rows = $(".table-resep #tbody-resep-obat tr");

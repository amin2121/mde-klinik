							...
							<div class="tabbable">
								...
								<div class="tab-content" style="margin-bottom: 2em !important;">
									...
									<div class="tab-pane" id="tambah-supplier">
										<form action="<?= base_url('apotek/supplier/tambah_supplier') ?>" id="form-tambah-supplier" method="POST">
...
<script>
	...
	function get_supplier() {
		...
		$.ajax({
			url : '<?= base_url('apotek/supplier/get_supplier_with_bank_ajax') ?>',
			method : 'POST',
									...
									<div id="modal_ubah_supplier_${item.id}" class="modal fade">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<form action="<?= base_url('apotek/supplier/ubah_supplier') ?>" id="form-ubah-supplier" method="POST">
									...
									<div id="modal_hapus_supplier_${item.id}" class="modal fade">
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-footer">
													<button class="btn btn-link" data-dismiss="modal"><i class="icon-cross position-left"></i> keluar</button>
													<a href="<?= base_url('apotek/supplier/hapus_supplier?id_supplier=') ?>${item.id}" class="btn btn-danger"><i class="icon-trash position-left"></i> Hapus</a>
												</div>
											</div>
										</div>
									</div>

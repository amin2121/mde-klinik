								...
								<div class="form-search form-horizontal">
									...
									<div class="row" style="margin-top: 1em;">
										<div class="col-sm-6">
											...
											<button class="btn btn-success" onclick="get_riwayat_stok_opname()"><i class="icon-book2 position-left"></i> Lihat Semua</button>
										</div>
									</div>
...
function get_riwayat_stok_opname() {
	...
	$.ajax({
		url : '<?= base_url('apotek/riwayat_stok_opname/get_riwayat_stok_opname') ?>',
		method : 'POST',
		data : {

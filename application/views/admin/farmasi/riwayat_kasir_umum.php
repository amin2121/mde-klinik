...
<div id="modal-hapus-transaksi" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url('farmasi/riwayat_kasir_umum/hapus_riwayat_kasir_umum') ?>" method="POST">
...
function get_riwayat_kasir_umum() {
	...
	$.ajax({
		url : '<?= base_url('farmasi/riwayat_kasir_umum/get_riwayat_kasir_umum') ?>',
		method : 'POST',
		data : {
...
function print_struk_kasir_umum(id_penjualan) {
	window.open('<?php echo base_url(); ?>farmasi/riwayat_kasir_umum/print_struk_kasir_umum/' + id_penjualan, '_blank','location=yes,height=570,width=520,scrollbars=yes,status=yes');
}
...
function get_detail_riwayat_kasir_umum(id) {
	...
	$.ajax({
		url : '<?= base_url('farmasi/riwayat_kasir_umum/get_detail_riwayat_kasir_umum') ?>',
		method : 'POST',
		...
		success : (res) => {
			...
			var tfoot = `
				<tr>
					...
					<td class="text-center"><b>Rp. </b>${total_harga}</td>
				</tr>
			`

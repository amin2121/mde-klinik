				...
				<div class="panel-body">
					<div class="row">
						<div class="col-sm-12">
							...
							<form action="<?= base_url('farmasi/faktur/ubah_detail_faktur?id_faktur='. $this->input->get('id_faktur').'&id_detail_faktur='.$this->input->get('id_detail_faktur')) ?>" method="POST" class="form-horizontal" id="form-ubah-detail-faktur">
								...
								<div class="row">
									<div class="col-sm-10">
										<a href="<?= base_url('farmasi/faktur/detail_faktur?id_faktur='. $this->input->get('id_faktur')) ?>" class="btn btn-default" style="margin-right: 1em !important;"><i class="icon-arrow-left7"></i> Kembali</a>

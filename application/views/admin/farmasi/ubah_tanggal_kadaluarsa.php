					...
					<div class="row">
						<div class="col-sm-12">
							...
							<!-- message -->
								...
								<form action="<?= base_url('farmasi/stok_barang/action_ubah_tanggal_kadaluarsa?id_barang='. $barang['id']) ?>" class="form-horizontal" id="form-tanggal-kadaluarsa" method="POST">
									...
									<a href="<?php echo base_url(); ?>farmasi/stok_barang/"><button class="btn btn-md btn-default" type="button"><i class="icon-arrow-left7 position-left"></i> Kembali</button></a>

									...
									<div class="tab-content">
										...
										<div class="tab-pane" id="tambah-rak">
											<fieldset class="content-group">
												<form action="<?= base_url('farmasi/rak/tambah_rak') ?>" method="POST">
...
function get_rak() {
	...
	$.ajax({
		url : '<?= base_url('farmasi/rak/get_rak_ajax') ?>',
		method : 'POST',
		data : {'search' : `${rak}`},
		dataType : 'json',
		beforeSend : () => {
						...
						<tr>
							...
							<td>
								<div class="text-center">
									<a href="<?= base_url('farmasi/rak/view_barang_rak/') ?>${item.id}" class="btn btn-md btn-icon btn-info"><i class="icon-basket position-left"></i> Barang Rak</a>
								...
								<div id="modal_ubah_rak_${item.id}" class="modal fade">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<form action="<?= base_url('farmasi/rak/ubah_rak') ?>" method="POST">
								...
								<div id="modal_hapus_rak_${item.id}" class="modal fade">
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-footer">
												<a href="<?= base_url('farmasi/rak/hapus_rak?id=') ?>${item.id}" class="btn btn-danger"><i class="icon-bin position-left"></i> Hapus</a>

<!-- Second navbar -->
	<div class="navbar navbar-default" id="navbar-second">
		...
		<div class="navbar-collapse collapse" id="navbar-second-toggle">
			<ul class="nav navbar-nav navbar-nav-material">
				<li><a href="<?php echo base_url() ?>resepsionis/resepsionis_home"><i class="icon-display4 position-left"></i> Home</a></li>
				<?php
					$level = $this->session->userdata('level');
					$q_menu = $this->db->query("SELECT a.* FROM pengaturan_hak_akses a LEFT JOIN menu_2 b ON a.id_menu = b.id WHERE a.level = '$level' AND a.tipe_menu = 'Menu 2' AND b.id_menu_1 = '1'")->result_array();
					foreach ($q_menu as $p) {
						$id_menu = $p['id_menu'];
	...
	<div id="popup_load">
		<div class="window_load">
				<img src="<?=base_url()?>assets/loading.gif" height="150" width="150">
		</div>
	</div>

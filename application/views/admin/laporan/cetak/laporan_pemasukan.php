      ...
      <?php
          ...
          <tr>
            ...
            <td style="text-align:center;">
              ...
              }elseif ($r['status'] == 'Pembayaran') {
                echo "Pembayaran Pasien Tanggal ".$r['nama_pemasukan'];
              }elseif ($r['status'] == 'Farmasi Umum') {
                echo "Pembayaran Farmasi Umum Tanggal ".$r['nama_pemasukan'];
              }
              ?>
            </td>

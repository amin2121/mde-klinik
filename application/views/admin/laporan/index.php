            ...
            <div class="content-wrapper">
                ...
                <div class="panel panel-flat border-top-success border-top-lg">
                    <div class="panel-heading">
                        <h5 class="panel-title">Selamat Datang di Menu Laporan,</h5>
                    </div>

                    <div class="panel-body">
                        <p class="content-group"> Silahkan Klik menu disamping untuk memulai layanan Laporan</p>
                        <div class="row">
                        <?php
                        ...
                        foreach ($q_menu as $p) {
                            ...
                            if ($m['link'] == '' || $m['link'] == null) {
                             ...
                             <div class="col-sm-3" >
                                 ...
                                 <div class="panel panel-bordered panel-success" style="height: 180px !important;">
                                     <div class="panel-body">

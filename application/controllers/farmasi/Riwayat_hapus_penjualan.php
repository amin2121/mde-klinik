...
class Riwayat_hapus_penjualan extends CI_Controller {
	...
	public function __construct(){
		parent::__construct();
		$this->load->model('farmasi/M_riwayat_hapus_penjualan', 'model');
	}
	...
	public function index(){
		...
		$this->load->view('admin/farmasi/riwayat_hapus_penjualan', $data);
	}
	...
	public function detail_penjualan(){
	    ...
	    $data['row'] = $this->model->farmasi_penjualan_row($id);
	    $data['res'] = $this->model->farmasi_penjualan_detail_result($id);
  	...
  	public function hapus_semua_riwayat_penjualan()
  	{
  		if($this->model->hapus_semua_riwayat_penjualan()) {
			...
			redirect('farmasi/riwayat_hapus_penjualan/');
		} else {
...
/* Location: ./application/controllers/farmasi/Riwayat_hapus_penjualan.php */

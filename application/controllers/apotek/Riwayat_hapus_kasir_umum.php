...
class Riwayat_hapus_kasir_umum extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/apotek/riwayat_hapus_kasir_umum', $data);	
	}
	...
	public function hapus_semua_riwayat_kasir_umum()
	{
		if($this->model->hapus_semua_riwayat_kasir_umum()) {
			...
			redirect('apotek/riwayat_hapus_kasir_umum/');
		} else {
...
/* Location: ./application/controllers/apotek/Riwayat_hapus_kasir_umum.php */
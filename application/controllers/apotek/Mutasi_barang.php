...
class Mutasi_barang extends CI_Controller {
	...
	public function __construct(){
		parent::__construct();
		$this->load->model("apotek/M_mutasi_barang", 'model');
	}
	...
	public function index(){
		...
		$this->load->view('admin/apotek/mutasi_barang', $data);
	}
	...
	public function tambah_mutasi_barang(){
		...
		$this->db->insert("apotek_mutasi_barang", $data);

		$id_apotek_mutasi_barang = $this->db->insert_id();

		if($this->model->tambah_mutasi_barang($id_apotek_mutasi_barang)) {
			$this->session->set_flashdata('message', 'Mutasi Barang Berhasil <span class="text-semibold">Ditambahkan</span>');
			$this->session->set_flashdata('status', 'success');
			redirect('apotek/mutasi_barang');
		} else {
...
/* Location: ./application/controllers/apotek/Mutasi_barang.php */

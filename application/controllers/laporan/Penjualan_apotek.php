...
class Penjualan_apotek extends CI_Controller {
	...
	public function index(){
	    ...
	    $data['title'] = 'Penjualan Apotek';
	    $data['menu'] = 'laporan';
      $data['cabang'] = $this->db->get('data_cabang')->result_array();

	    $this->load->view('admin/laporan/laporan_penjualan_apotek', $data);
	}
    ...
    if ($this->input->post('id_cabang') == 'semua') {
      ...
      $and = "AND a.id_cabang = '$id_cabang'";
        ...
        ");
	      ...
	      $data['title'] = 'Laporan Penjualan Apotek Per Hari';
        $data['nama_cabang'] = $nama_cabang;
	      $this->load->view('admin/laporan/cetak/laporan_penjualan_apotek', $data);
        ...
        $and
	      ...
	      $data['title'] = 'Laporan Penjualan Apotek Per Bulan';
        $data['nama_cabang'] = $nama_cabang;
	      $this->load->view('admin/laporan/cetak/laporan_penjualan_apotek', $data);
        ...
        $and
	      ...
	      $data['tahun'] = $tahun;
	      $data['filter'] = 'tahun';
	      $data['title'] = 'Laporan Penjualan Apotek Per Tahun';
        $data['nama_cabang'] = $nama_cabang;
	      $this->load->view('admin/laporan/cetak/laporan_penjualan_apotek', $data);
		}
	}

  ...
  public function print_laporan(){
    ...
    if ($filter == 'hari') {
      ...
      $tanggal_sql = $this->db->query("SELECT
                                        ...
                                        a.total_invoice AS nominal,
                                        a.tanggal,
                                        'Pembayaran' AS status
                                        ...
                                        SELECT
                                        a.tanggal AS nama_pemasukan,
                                        a.nilai_transaksi AS nominal,
                                        a.tanggal,
                                        'Farmasi Umum' AS status
      ...
      $data['title'] = 'Hari';
      $this->load->view('admin/laporan/cetak/laporan_pemasukan', $data);
